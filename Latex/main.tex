...
La grammatica 6 viene riportata in questo report in quanto contiene delle $\epsilon$-produzioni e come specificato nelle sezione \ref{inputformat} dedicata al Formato dell'Input le $\epsilon$-produzioni dovranno essere scritte utilizzando il simbolo 
$\sim$. \\
